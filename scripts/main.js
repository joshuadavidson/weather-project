var userData = {
  ...
  weather: {
    ...
    imperial: { //data in imperial units
      temp: 0, //Fahrenheit
      tempUnits: "&degF",
      windSpeed: 0, //mph
      windSpeedUnits: "mph"
    },
    metric: { //data in metric units
      temp: 0, //Celsius
      tempUnits: "&degC",
      windSpeed: 0, //kph
      windSpeedUnits: "kph"
...
function getUserLocation() {
  ...
  $.ajax({
    ...
    error: function() {
      alert("City, State, Country data could not be found.");
      getUserWeather();
    }
  });
}
...
function printUserData(unitSystem) {
  ...
  $("#weatherIcon").removeClass().addClass(function() {
    return "wi " + iconLookup[userData.weather.icon] + " fa-5x";
  });
